...
function send_notification {
    ...
    # Send the notification
     dunstify -i /home/Reji/Me/Pictures/sysicon/volume-up.png -t 8000 -r 2593 -u normal -h int:value:"$volume" "Volume: ${volume}%"
}
...
function send_notification1 {
    ...
    bar=$(seq -s "─" $(($volume / 2)) | sed 's/[0-9]//g')
    # Send the notification
     dunstify -i /home/Reji/Me/Pictures/sysicon/volume-down.png -t 8000 -r 2593 -u normal -h int:value:"$volume" "Volume: ${volume}%"
}
case $1 in
    up)
	...
	# Up the volume (+ 2%)
    amixer set Master 2%+
    #The below one was working before the brekdown of arch linux
	...
	if is_mute ; then
        dunstify -i /home/Reji/Me/Pictures/sysicon/volume-mute.png -t 8000 -r 2593 -u normal "Volume: Mute"
    else
        send_notification
	fi
	;;
